...
result_xpath = '//div[@class="result results_links_deep highlight_d result--url-above-snippet"]'  # noqa
...
answer_title_xpath = '//*[@id="links_wrapper"]/div[2]/div[1]/div/div[1]/div/a/div[1]'
answer_link_xpath = '//*[@id="links_wrapper"]/div[2]/div[1]/div/div[1]/div/a/div[2]'
answer_content_xpath = '//*[@id="links_wrapper"]/div[2]/div[1]/div/div[1]/div/div/span'
...
def _fetch_supported_languages(resp):
    ...
    supported_languages = map(
        (lambda x: x[3:] + "-" + x[:2].upper()), regions_json.keys()
    )
